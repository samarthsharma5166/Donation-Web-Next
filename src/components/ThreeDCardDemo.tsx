...
export function ThreeDCardDemo({id, heading, subHeading, src }:CardProps) {
    return (
            ...
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[24rem] h-auto rounded-xl p-6 border  ">
                ...
                <div className="flex justify-between items-center mt-20">
                    ...
                    <CardItem
                        translateZ={20}
                        as="button"
                        className="px-4 py-2 rounded-xl bg-[#867156] dark:bg-white dark:text-black text-white text-xs font-bold"
                    >
                        <Link href={`/blogs/${id}`}>
                            Read More
                        </Link>
